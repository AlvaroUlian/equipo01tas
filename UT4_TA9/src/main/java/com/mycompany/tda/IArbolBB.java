...
public interface IArbolBB<T> {
    ...
    /**
     * Mediante PreOrden se retornan los elementos del árbol, separados por guiones.
     *
     * @return String conteniendo el preorden de las etiquetas, separado por guiones.
     */
    public String preOrdenEtiqueta();
     ...
     */
    public Lista<T> inOrdenListaDatos();
