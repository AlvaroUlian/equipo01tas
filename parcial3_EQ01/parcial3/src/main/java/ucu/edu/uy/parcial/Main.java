...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        abo.armarArbolBinario(0,cantElementos, claves, arbolOptimo);
        ...
        System.out.println(clave1 + " : " + costoClave1);
        long costoClave2 = arbolOptimo.obtenerCosto(clave2);
        System.out.println(clave2 + " : " + costoClave2);
        long costoClave3 = arbolOptimo.obtenerCosto(clave3);
        System.out.println(clave3 + " : " + costoClave3);
        long costoClave4 = arbolOptimo.obtenerCosto(clave4);
        System.out.println(clave4 + " : " + costoClave4);
